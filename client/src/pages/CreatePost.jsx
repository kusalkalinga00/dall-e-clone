...
const CreatePost = () => {
    ...
    if (form.prompt) {
      try {
        ...
        const response = await fetch(
          "https://dall-e-clone-4gkj.onrender.com/api/v1/dalle",
          {
            method: "POST",
            headers: {
  ...
  const handleSubmit = async (e) => {
    ...
    if (form.prompt && form.photo) {
      ...
      try {
        const response = await fetch(
          "https://dall-e-clone-4gkj.onrender.com/api/v1/post",
          {
            method: "POST",
      ...
      <form className="mt-16 max-w-3xl" onSubmit={handleSubmit}>
        <div className="flex flex-col gap-5">
          ...
          <FormField
            ...
            type="text"
            name="prompt"
            placeholder="an oil painting portrait of Albert Einstein"
            value={form.prompt}
            handleChange={handleChange}
            isSurpriseMe
